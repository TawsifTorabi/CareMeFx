...
public class HomeController implements Initializable {
    ...
    Timeline alertTimer = new Timeline(new KeyFrame(Duration.seconds(User.TimerDuration), event -> {
        showAlert();
    }));
    ...
    @FXML private void SwitchToBMI(ActionEvent event) throws IOException {
        ...
        Pane view = object.getPage("BMIcounter.fxml");
        MainStageScreen.setCenter(view);
    }

    @FXML private void SwitchToDiet(ActionEvent event) throws IOException {
        FxmlLoader object = new FxmlLoader();
        Pane view = object.getPage("DietPlan.fxml");
        MainStageScreen.setCenter(view);
    }

    @FXML private void SwitchToWorkout(ActionEvent event) throws IOException {
        FxmlLoader object = new FxmlLoader();
        Pane view = object.getPage("ExerciseRoutine.fxml");
        MainStageScreen.setCenter(view);
    }
    ...
    public void LoadWelcome(){
        FxmlLoader object2 = new FxmlLoader();
        Pane view2 = object2.getPage("HomeWelcome.fxml");
        MainStageScreen.setCenter(view2);
